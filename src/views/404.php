...
<body class="bg-gray-100 dark:bg-gray-900 flex items-center justify-center min-h-screen transition-colors duration-300">
  ...
  <div class="bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-xl text-center max-w-md w-full">
    ...
    <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-2">Página no encontrada</h2>
    <p class="text-gray-600 dark:text-gray-400 mb-6">
      Lo sentimos, la página que estás buscando no existe o fue movida.
    </p>

    <a href="/" class="inline-block bg-blue-600 text-white px-6 py-2 rounded-xl hover:bg-blue-700 transition duration-200 font-medium">
      Volver al inicio
    </a>
